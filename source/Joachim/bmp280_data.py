...
def bme280data(sea_level_pressure, port):
    ...
    altitude = ((((sea_level_pressure/pressure)**(1/5.257))-1)*(temperature+273.15-2))/0.0065
    
    return [round(altitude), round(temperature-2)]
...
if __name__ == "__main__":
    ...
    values_1 = bme280data(1018.00, 1)
    #values_2 = bme280data(1013.25, 3)
    #values_3 = bme280data(1013.25, 4)
    #values_4 = bme280data_triple(1013.25)
    print(values_1)
    #print(values_2)
    #print(values_3)
    #print("")
